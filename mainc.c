 ...
 *
 * in this version SIM800L radio is NOT switched OFF
 * instead only SIM800L SLEEP MODE is used to 
...
const char HTTPAPIKEY[] PROGMEM = { "XXXXXXXXXXXXXXX" };   // Put your THINGSPEAK API KEY HERE !!!
